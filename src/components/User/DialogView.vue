                ...
                <v-container class="mt-10" style="background-color: rgb(247, 247, 247);">
                    <v-row>
                        ...
                        <v-col cols="12" style="font-size: 13px;">
                            ...
                            <v-text-field v-model="phonenumber" placeholder="Nhập số điện thoại người dùng"
                                style="background-color: white;" density="compact" single-line hide-details
                                variant="outlined"></v-text-field>
                        ...
                        <v-col cols="12" style="font-size: 13px;">
                            ...
                            <v-text-field v-model="imageUrl" placeholder="Nhập link ảnh avatar"
                                style="background-color: white;" density="compact" single-line hide-details
                                variant="outlined"></v-text-field>
...
const { value: imageUrl, errorMessage: imageUrlError } = useField(
    'imageUrl',
    yup
        .string()
        .required('Không được bỏ trống')
